    ...
    <div>
      ...
      <div className="chat-message">
        ...
        <div className="d-flex mt-2">
          ...
          />
          <Button variant="contained" className="ms-3" onClick={onSend}>
            Send
          </Button>
        </div>
        <div id="copyright" className="mt-3">
          Copyrights Reserved ChatBot
        </div>
      </div>
    </div>
  );
